            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3">
                <div class="card card-shadow-blue img-cards">
                    ...
                    <button type="button" class="btn btn-outline-primary start-btn blue-border blue-text fw-bold"
                        data-bs-toggle="modal" data-bs-target="#exampleModal">START</button>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3">
                <div class="card card-shadow-yellow img-cards">
                    ...
                    <button type="button"
                        class="btn btn-outline-primary start-btn yellow-btn yellow-border yellow-text fw-bold">START</button>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3">
                <div class="card card-shadow-green img-cards">
                    ...
                    <button type="button"
                        class="btn btn-outline-primary start-btn green-border green-text fw-bold">START</button>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3">
                <div class="card card-shadow-red img-cards">
                    ...
                    <button type="button"
                        class="btn btn-outline-primary start-btn red-border red-text fw-bold">START</button>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3">
                <div class="card card-shadow-pink img-cards">
                    ...
                    <button type="button"
                        class="btn btn-outline-primary start-btn pink-border pink-text fw-bold">START</button>
                </div>
            </div>
        </div>
