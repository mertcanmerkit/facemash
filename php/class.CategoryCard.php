...
";
    ...
    private function renderFooter()
    {
        return ' </div>
                ...
                <button type="button" class="btn btn-start-category-' . $this->categoryId . ' btn-outline-primary start-btn ' . $this->color . '-border ' . $this->color . '-text fw-bold" id="startMashBtn" onclick="startModalWithCategory(\'' . $this->categoryId . '\')">
